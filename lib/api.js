...
api = {
    ...
    uploadBinary : function(uri, data, contentType) {
        return this._request({
            body : data,
    ...
    createAlbum : function(params) {
        ...
        return this.getServiceDocument(this._username).then(function(res) {
            return _this.uploadBinary(res.collections['album-list'].href, JSON.stringify({
                title : params.title,
        ...
        var _this = this,
            ...
            upload = function(uri) {
                ...
                if(typeof params === 'object') {
                    ...
                    return _this.uploadBinary(uri, FS.readFileSync(path), 'image/' + extname);
                }
            };
